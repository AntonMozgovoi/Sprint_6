...
class MainPageLocators:
    ...
    SCOOTER_LOGO = (By.XPATH, '//*[starts-with(@class, "Header_LogoScooter__3lsAR")]')
    YANDEX_LOGO = (By.XPATH, '//*[starts-with(@class, "Header_LogoYandex__3TSOI")]')
...
class SecondFormFields:
    ...
    SECOND_BUTTON_ORDER = (By.XPATH,
                           '//button[starts-with(@class, "Button_Button__ra12g Button_Middle_") and text()="Заказать"]')
    BUTTON_CONFIRM = (By.XPATH, '//button[starts-with(@class, "Button_Button__ra12g Button_Middle") and text()="Да"]')
